...
(function() {
  ...
  document.addEventListener("DOMContentLoaded", function() {
    ...
    if (isotopeItem) {
        ...
        let initIsotope;
        let currentCategoryFilter = '*';  // Pour garder trace du filtre de catégorie actif
        let currentSearchTerm = '';       // Pour garder trace du terme de recherche actif
            ...
            function applyFilters() {
                initIsotope.arrange({
                    filter: function(itemElem) {
                        const element = itemElem;
                        
                        // Vérifier si l'élément correspond au filtre de catégorie
                        const matchesCategory = currentCategoryFilter === '*' ? 
                            true : 
                            element.classList.contains(currentCategoryFilter.replace('.', ''));
                        ...
                        const matchesSearch = currentSearchTerm === '' ? 
                            true : 
                            productNameElement && 
                            productNameElement.textContent.toLowerCase().includes(currentSearchTerm);
                        
                        // L'élément doit correspondre aux deux filtres
